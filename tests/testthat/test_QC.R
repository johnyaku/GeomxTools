...
# spec 1: test that the number of Low Negatives is correct:------
...
# spec 2: test that the number of High NTC is correct:------
...
# spec 1: test that the number of Low Probe Ratio is correct:------
...
# spec 2: test that the Local Grubbs Outlier is correct:
...
# spec 4: test that the Global Grubbs Outlier is correct:
